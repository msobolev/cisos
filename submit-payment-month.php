		...
		<div class="shell-new-inner">
			...
			<div class="step-field-box">
                     ...
                     <!-- <form name="frmSubmitPay" id="frmSubmitPay" method="post" action="res-price-process.php?action=SubmitPaymentPrice" onsubmit="return SubmitPaymentValidation();" >-->
					  <form name="frmSubmitPay" id="frmSubmitPay" method="post" action="res-free-process.php?action=SubmitPaymentFreeRacaring&free=1Month&res_id=<?=$res_id?>" onsubmit="return SubmitPaymentValidation();" >
						<div class="inner-field-box-submit">
                            <div class="newpadding2" style="padding-top:30px;padding-bottom:20px;"">
                            	<div class="new-payment-text">1 Month free trial – your card will not be charged until the free trial is over</div>
                            </div>	
							...
							<table width="540" border="0" align="center" cellpadding="0" cellspacing="0">
							  ...
							  <tr>
								...
								<div class="name-field-box ">Billing Address :
									...
									<input type="hidden" name="startDate" id="startDate" size="35" value="<?=date('d/m/Y',mktime(0, 0, 0, date("m")+1  , date("d"), date("Y")));?>" />
								</div>
							...
							<div class="buttn-box">
							<div class="blue-buttn"><input type="image" name="pay_submit"  src="css/images/confirm.jpg" /><!--<a href="javascript:;" onclick="SubmitPaymentValidation();"><span>Confirm</span></a>--></div>
							</div>	
					</div>
					</form>
