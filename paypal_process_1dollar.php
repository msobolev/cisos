  ...
  <body style="text-align:center;">
    ...
    <img src="images/loading.gif" alt="" title="">
  	<p><h2>Redirecting you to PayPal site now. Please wait...</h2></p>
        ...
        <form name="frmPayPalProcess"action="https://www.paypal.com/cgi-bin/webscr" method="post"> <!-- testing https://www.sandbox.paypal.com/cgi-bin/webscr   Live https://www.paypal.com/cgi-bin/webscr-->
            <input type="hidden" name="business" value="Mike_Sobolev@yahoo.com"><!-- testing ananga_1275462143_biz@gmail.com   Live Mike_Sobolev@yahoo.com-->
