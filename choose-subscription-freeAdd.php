...
$res_id = isset($_REQUEST["res_id"]) ? $_REQUEST["res_id"] : $_REQUEST["resID"];
...
<body>
	...
	<!-- Main -->
	<div id="main">
		<form method="post" name="frmChooscSub" id="frmChooscSub" action="res-process.php?action=Subscription&res_id=<?=$res_id?>">
		<!-- Shell -->
		<div class="shell-new">
		<div class="shell-new-inner">
			...
			<!-- shell -->
				<div class="shell-new">
					<div class="main-heading" style="clear:both;">
						<div>
