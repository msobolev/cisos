...
<input type="hidden" name="redirect_cmd" value="<?=$paypal[redirect_cmd]?>"> 
...
<input type="hidden" name="amount_1" value="<?=$paypal[amount]?>">
...
<!--<input type="hidden" name="item_name_1" value="T1">
<input type="hidden" name="item_name_2" value="T2"> 
...
<input type="hidden" name="item_number_2">
<input type="hidden" name="on0_1">
<input type="hidden" name="os0_1">
<input type="hidden" name="on1_1">
<input type="hidden" name="os1_1">
...
<input type="hidden" name="os1_2">
 -->
<!--<input type="hidden" name="amount2" value="15"> -->

<!--
<input type="hidden" name="item_name_1" value="<?=$paypal[item_name_1]?>">
...
<input type="hidden" name="custom" value="<?=$paypal[custom_field]?>">
<!--<input type="hidden" name="email" value="<?//=$paypal[email]?>">   -->
<!--<input type="hidden" name="email" value="tapan@roytechsolutions.com"> -->
