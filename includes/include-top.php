...
// make a connection to the database... now
		...
		{
			//echo "in if";
			//com_db_connect() or die('Unable to connect to database server because:<br> '.mysql_error());
			//echo "<br>Reason: ";
		}
		else
                {
                        //echo "in else";
			com_db_connect() or die('Unable to connect to database server!'.send_email_alert());
                }        
