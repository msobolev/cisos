...
<title><?PHP if($current_page!='movement.php'){echo 'CISOsOnTheMove.com ::';}?> <?=$PageTitle;?></title>
...
<div id="light" class="white_content" style="display:<?PHP if($search_msg=='Result Not Found'){ echo 'block';} else { echo 'none'; } ?>;">
...
<div id="light-free" class="white_content_free" style="display:<?PHP if($user_info=='FreeUser'){ echo 'block';} else { echo 'none'; } ?>;">
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td align="left" valign="top"><img src="images/specer.gif" width="1" height="50" alt="" title="" /> </td>
      </tr>
...
<div id="fade" class="black_overlay" style="display:<?PHP if($search_msg=='Result Not Found'){ echo 'block';} else { echo 'none'; } ?>;"></div>
<div id="fade-free" class="black_overlay" style="display:<?PHP if($user_info=='FreeUser'){ echo 'block';} else { echo 'none'; } ?>;"></div>
<?PHP } ?>

<div class="header">
    <div class="shell">
    	<?PHP if($current_page=='advance-search.php' || $current_page=='search-result.php' || $current_page=='alert.php'){ ?>
        <h1 id="new-logo" style="padding-left:0px;"><a href="<?=HTTP_SERVER?>index.php">CISOs on the Move</a></h1>
		<?PHP }else{ ?>
        <h1 id="new-logo"><a href="<?=HTTP_SERVER?>index.php">CISOs on the Move</a></h1>
        <?PHP } ?>
