		...
		<div class="profile-cnt">
			<div class="shell clearfix">
				<div class="profile-description">
                	<? if($personal_row['personal_image'] !='' ) { ?>
					<div class="profile-img" style="background-color:#FFF;">
						<img src="<?=HTTP_CTO_URL?>personal_photo/thumb/<?=$personal_row['personal_image']?>" alt="<?=com_db_output($personal_row['first_name'].' '.$personal_row['last_name']);?>" title="<?=com_db_output($personal_row['first_name'].' '.$personal_row['last_name'])?>" height="200px" width="200px" style="position:absolute;top:0;bottom:0;margin:auto;"/>
					</div>
                    <? }else{ echo '<br>';}?>
					<!-- /profile-img -->
					<div class="cl">&nbsp;</div>
