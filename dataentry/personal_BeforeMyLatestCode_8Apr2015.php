...
$pID = (isset($_GET['pID']) ? $_GET['pID'] : $select_data[0]);
    ...
    switch ($action) {
	  ...
	  case 'edit':
		...
		case 'editsave':
			...
			modify_date = '".$modify_date."',create_by='".$create_by."',admin_id='".$login_id."',demo_email='".$demo_email."',person_tigger_name='".$person_tigger_name."' where personal_id = '" . $pID . "'";
			com_db_query($query);
	...
	case 'addsave':
			...
			edu_ugrad_specialization, edu_ugrad_college, edu_ugrad_year, edu_grad_degree ,edu_grad_specialization ,edu_grad_college, edu_grad_year,add_date, create_by,admin_id, demo_email, person_tigger_name, status) 
			...
			'$edu_ugrad_specialization','$edu_ugrad_college','$edu_ugrad_year','$edu_grad_degree','$edu_grad_specialization','$edu_grad_college','$edu_grad_year','$add_date','$create_by','$login_id','$demo_email','$person_tigger_name','$status')";
			com_db_query($query);
		  ...
		  <table width="95%" align="left" cellpadding="5" cellspacing="5" border="0" style="position:relative;">
            ...
            <tr>
			  <td align="right" style="color: #064962;font-family: Arial;font-size:13px;font-weight:bold;padding-right:150px;">
              	...
              	<div id="person_tigger" style="display:none;">
