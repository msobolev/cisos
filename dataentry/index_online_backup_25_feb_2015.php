                ...
                <table width="100%" cellpadding="4" cellspacing="4" border="0">
                    ...
                    <tr>
                       <td width="25%" align="left" class="page-text" valign="top">&nbsp;&nbsp;&nbsp;Last Name:</td>
                        <td width="75%" align="left" valign="top">
							...
							<!-- <span onClick="generate_email_address()">Generate Email address</span> -->
                    ...
                    <tr>
                       <td width="25%" align="left" class="page-text" valign="top">&nbsp;&nbsp;&nbsp;Email:</td>
                        <td width="75%" align="left" valign="top">
                            <input type="text" name="person_email" id="person_email" size="30" value="" onblur="PersonalDetailsShow('person_email','movement_entry');"/>&nbsp;&nbsp;<input type="checkbox" name="email_verified" id="email_verified" value="Yes" onclick="ShowEmailVerifiedDate();" />Verified &nbsp;<span id="email_verified_date" /></span>
                        </td>
                    </tr>
                    <tr>
					...
					<tr>
                      ...
                      <td width="75%" align="left" valign="top">
                        <div id="div_company_email_domain">
							<input type="input" name="company_email_domain" id="company_email_domain" style="width:206px;">
