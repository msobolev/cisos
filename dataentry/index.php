...
if($action == 'MovementSearchResult' || $action == 'Directory'){
	$title			= $_REQUEST['search_title'];
	$company_name	= $_REQUEST['search_company_name'];
	$company_url	= $_REQUEST['search_company_url'];
	$first_name		= $_REQUEST['search_first_name'];
	$last_name		= $_REQUEST['search_last_name'];
	...
	if($company_url!=''){
		if($search_qry==''){
			$search_qry .= " (c.company_website like '%".$company_url."' OR company_urls like '".$company_url."')";
		}else{
...
$mID = (isset($_GET['mID']) ? $_GET['mID'] : $select_data[0]);
	...
	case 'addsave':
            ...
            $ciso_user_clause = '';
            $ciso_update = '';
            $ciso_filters = array('CISO','ciso','Chief Information Security Officer','information security','cyber security','technology security','IT security');
            ...
            $first_name = trim(com_db_input($_POST['first_name']));
            $middle_name = trim(com_db_input($_POST['middle_name']));
            $last_name = trim(com_db_input($_POST['last_name']));

            $_POST['person_email'] = trim($_POST['person_email']);

            $person_email = trim(com_db_input($_POST['person_email']));
            $person_phone = trim(com_db_input($_POST['person_phone']));
            ...
            else
            {
                ...
                elseif($company_name_full != '')
                    $company_name = str_replace(' ','-',$company_name_full);
                ...
                //echo "<br>select move_id from ".TABLE_MOVEMENT_MASTER." where movement_url='".$movement_url."'";
                //die();
                $isMovementID = com_db_GetValue("select move_id from ".TABLE_MOVEMENT_MASTER." where movement_url='".$movement_url."'");
            }
            if($isMovementID =='')
            {
                ...
                if($isPersonalID =='' || $_POST['person_option'] == 'New')
                {
                    ...
                    (first_name, middle_name, last_name, email,email_verified, email_verified_date, phone,facebook_link,linkedin_link,twitter_link,googleplush_link,about_person, add_date, create_by,admin_id, status $ciso_user_col) 
                    values ('$first_name', '$middle_name', '$last_name', '$person_email','$email_verified','$email_verified_date','$person_phone','$person_facebook_link','$person_linkedin_link','$person_twitter_link','$person_googleplush_link','$about_person','$add_date','$create_by','$login_id','$status' $ciso_user_clause)";
                ...
                else
                {
                    ...
                    if($ciso_update != '')
                    {
                        com_db_query("update ".TABLE_PERSONAL_MASTER." set $ciso_update where personal_id='".$personal_id."'");
                    }        
          ...
          <tr>
            ...
            <td width="254" align="right" valign="top" >
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="login-register-text"><a href="#"><strong><?=$_SESSION['user_login_name']?></strong></a> | <a href="logout.php"><strong>Logout</strong></a>				
                    </tr>
                </table>
            </td>
          </tr>
...
<?PHP if($action=='Directory' || $action =='save' || $action=='MovementSearchResult'){	?>	
        <tr>
		...
		<tr>
			...
			<?php echo number_pages($main_page, $p, $total_data, 8, $items_per_page,'&action=Directory&search_title='.$_REQUEST['search_title'].'&search_company_name='.$_REQUEST['search_company_name'].'&search_company_url='.$_REQUEST['search_company_url'].'&search_first_name='.$_REQUEST['search_first_name'].'&search_last_name='.$_REQUEST['search_last_name'].'&from_date='.$_REQUEST['from_date'].'&to_date='.$_REQUEST['to_date'].'&items_per_page='.$items_per_page);?>
			<br /><br />
	  		</td>
		</tr>
        ...
        ?>
		  ...
		  <script language="javascript" type="text/javascript">
			function chk_form_Add()
                        {
                            ...
                            if(company_name=='' && need_company == 1){
			...
			function ShowEmailVerifiedDate()
			{
                            ...
                            document.getElementById("person_email").style.backgroundColor = "white";
                ...
                <table width="100%" cellpadding="4" cellspacing="4" border="0">
                  	<tr>
                        ...
                        <td width="75%" align="left" valign="top">
                          <input type="text" name="title" id="title" size="30" onblur="populate_abt_person()" />
                   	</tr>
                  	<tr>
                    ...
                    <tr>
                       <td width="25%" align="left" class="page-text" valign="top">&nbsp;&nbsp;&nbsp;First Name:</td>
                        <td width="75%" align="left" valign="top">
                            <input type="text" name="first_name" id="first_name" size="30" onblur="populate_abt_person()" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                       <td width="25%" align="left" class="page-text" valign="top">&nbsp;&nbsp;&nbsp;Last Name:</td>
                        <td width="75%" align="left" valign="top">
                            <input type="text" name="last_name" id="last_name" size="30" onkeyup="PersonalCompanyNameMovementInLastName();"  onblur="populate_abt_person()" />
                    ...
                    <tr>
                        ...
                        <td width="75%" align="left" valign="top"><input type="text" name="announce_date" id="announce_date" size="30"  value="<?=$today_date?>" />
                    ...
                    <tr>
                        ...
                        <td width="75%" align="left" valign="top"><input type="text" name="effective_date" id="effective_date" size="30"  value="<?=$today_date?>" />
					 ...
					 <tr>
                        ...
                        <td width="75%" align="left" valign="top">
                        	<select name="movement_type" id="movement_type" style="width:208px;" onchange="DublicatMovementUrlCreate();">
                                ...
                                <?=selectComboBox("select id,name from ".TABLE_MANAGEMENT_CHANGE." where status=0 order by name",1)?>
                            </select><br />
		...
		<!--			
			...
			-->		
                    ...
                    <tr>
                        ...
                        <td width="75%" align="left" valign="top">
                        	<select name="source_id" id="source_id" style="width:208px;">
                                ...
                                <?=selectComboBox("select id,source from ".TABLE_SOURCE." where status=0 order by source",2)?>
                            </select>
                        </td>	
                    </tr>
                   ...
                   -->
                    ...
                    <tr>
                      <td width="25%" align="left" class="page-text" valign="top"><b>Source URL:</b></td>
