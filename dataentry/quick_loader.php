                        ...
                        */
                        ...
                        for($i=$columnheadings; $i<sizeof($filecontents); $i++) 
                        {
                            ...
                            if(sizeof($newArray)== 4)
                            {
                                ...
                                $import_company_url = trim(com_db_input(str_replace(';',',',trim($newArray['company_url']))));
                                $import_first_name = trim(com_db_input(str_replace(';',',',trim($newArray['first_name']))));
                                $import_last_name = trim(com_db_input(str_replace(';',',',trim($newArray['last_name']))));
                                $import_title = trim(com_db_input(str_replace(';',',',trim($newArray['title']))));
                                   ...
                                   // echo "<br>generated_email : ".$generated_email;
                                    ...
                                    if($email_pattern_id == '' ||  $email_pattern_id == '0')
                                    {
                                       ...
                                       if($personal_count == 0)
                                       {
                                           ...
                                           // the script will create a record, make it inactive and leave the email field empty.
                                           // Case 3
                                            $add_user_query = "INSERT into " . TABLE_PERSONAL_MASTER . "(first_name, last_name,status,quick_loader_result,about_person,phone,add_date,email,create_by $ciso_user_col) values('$import_first_name','$import_last_name',1,'email_bounce','$about_person_auto','$company_phone','$today_date','$generated_email','quick_load', $ciso_user)";
                                    ...
                                    { // PATTERN EXISTS
                                        ...
                                        else
                                        {
                                            ...
                                            $add_user_query = "INSERT into " . TABLE_PERSONAL_MASTER . "(first_name, last_name,status,quick_loader_result,about_person,phone,add_date,email,create_by $ciso_user_col) values('$import_first_name','$import_last_name',$personal_status_off,'email_bounce','$about_person_auto','$company_phone','$today_date','$generated_email','quick_load', $ciso_user)";
