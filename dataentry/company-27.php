    ...
    switch ($action) {
	  ...
	  case 'edit':
		...
		case 'editsave':
			...
			about_company = '".$about_company."', facebook_link = '".$facebook_link."', linkedin_link = '".$linkedin_link."', twitter_link = '".$twitter_link."', googleplush_link = '".$googleplush_link."',demo_job='".$demo_job."', modify_date = '".$modify_date."',create_by='".$create_by."',admin_id='".$login_id."' where company_id = '" . $cID . "'";
			com_db_query($query);
