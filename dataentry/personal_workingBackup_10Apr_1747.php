...
$pID = (isset($_GET['pID']) ? $_GET['pID'] : $select_data[0]);
    ...
    switch ($action) {
	  ...
	  case 'edit':
		...
		case 'editsave':
			...
			modify_date = '".$modify_date."',create_by='".$create_by."',admin_id='".$login_id."',demo_email='".$demo_email."',person_tigger_name='".$person_tigger_name."',executive_tigger_name='".$executive_tigger_name."' where personal_id = '" . $pID . "'";
			com_db_query($query);
	...
	case 'addsave':
			...
			edu_ugrad_specialization, edu_ugrad_college, edu_ugrad_year, edu_grad_degree ,edu_grad_specialization ,edu_grad_college, edu_grad_year,add_date, create_by,admin_id, demo_email, person_tigger_name, status,executive_tigger_name) 
			...
			'$edu_ugrad_specialization','$edu_ugrad_college','$edu_ugrad_year','$edu_grad_degree','$edu_grad_specialization','$edu_grad_college','$edu_grad_year','$add_date','$create_by','$login_id','$demo_email','$person_tigger_name','$status','$executive_tigger_name')";
			com_db_query($query);
...
function ExecutiveTiggerOnOff(){
				if(document.getElementById('executive_email').checked){
					document.getElementById('executive_tigger').style.display="block";
				}else{
					document.getElementById('executive_tigger').style.display="none";
				}
			}
		  ...
		  <script language="javascript" type="text/javascript">
			...
			function PersonTiggerOnOff(){
				if(document.getElementById('demo_email').checked){
					document.getElementById('person_tigger').style.display="block";
				}else{
					document.getElementById('person_tigger').style.display="none";
				}
			}
			</script>
		  ...
		  <table width="95%" align="left" cellpadding="5" cellspacing="5" border="0" style="position:relative;">
            ...
            <tr>
			  <td align="right" style="color: #064962;font-family: Arial;font-size:13px;font-weight:bold;padding-right:150px;">
				...
				<br><br>
				<div id="person_tigger" style="display:none;float:right;margin-right:210px;">
				...
				<div id="executive_tigger" style="display:none;float:right;margin-right:-336px;">
                	<select name="executive_tigger_name" id="executive_tigger_name">
                    	<option value="Appointments">Appointments</option>
                        <option value="Awards">Awards</option>
                        <option value="Board">Board</option>
                        <option value="Media Mention">Media Mention</option>
          ...
          <script language="javascript" type="text/javascript">
            ...
            <tr>
			  <td align="right" style="color: #064962;font-family: Arial;font-size:13px;font-weight:bold;padding-right:150px;">
				...
				<input type="checkbox" name="executive_email" id="executive_email" value="1" onclick="ExecutiveTiggerOnOff();" /> Include in Buyside Demo?
				<br><br>
				<div id="person_tigger" style="display: <? if ($demo_email==1){echo 'block';}else{echo 'none';}?>;">
                	<select name="person_tigger_name" id="person_tigger_name">
