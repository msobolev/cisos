...
<head>
	<title><? echo 'CTOsOnTheMove.com ::';?> Pricing</title>
...
<body>
	<div class="header">
		<div class="shell clearfix">
			<a href="#" class="logo">CTOs On The Move</a>
...
-->				
	...
	<div class="section section-grey section-slogan">
		<div class="shell">
			<h2 class="slogan">Get Updated Emails of IT Execs Who Recently Changed Jobs to Instantly Engage Them as Your Prospective Clients.</h2><!-- /.slogan -->
		</div><!-- /.shell -->		
	</div><!-- /.section section-grey section-slogan -->

	<div class="section section-logos">
		<div class="shell">
			<h2>CTOs On The Move is Trusted by</h2>
					...
					<div class="offer offer-professional">
						...
						<div class="offer-body">
						   ...
						   <?php 
							...
							<p><strong><? if(!ctype_digit($professional_download_contacts)){echo $professional_download_contacts;}else{ echo $professional_download_contacts.' profiles / month';}?></strong></p>
					...
					<div class="offer offer-standard">
						...
						<div class="offer-body">
						   ...
						   <?php 
							...
							<p><? if(!ctype_digit($standard_download_contacts)){echo $standard_download_contacts;}else{ echo $standard_download_contacts.' profiles / month';}?></p>
 							<p><span class="x-ico"></span></p>
						</div><!-- /.offer-body -->
					...
					<div class="offer offer-basic">
						...
						<div class="offer-body">
							...
							?>
 							...
 							<!--<p><strong>300</strong> profiles/month</p>-->
							<p><? if(!ctype_digit($basic_download_contacts)){echo $basic_download_contacts;}else{ echo $basic_download_contacts.' profiles / month';}?></p>
 							<p><span class="x-ico"></span></p>
						</div><!-- /.offer-body -->
				...
				<div class="col col-1of2">
					<ul class="testimonials clearfix">
						<li class="testimonial">
							...
							<p>Telwares’ primary audience is the CTO community – and accurate, timely information is mission critical to our success. CTOsOnTheMove has helped us quickly take advantage of opportunities with key marketing leaders, creating real client engagements and extraordinary return on investment.</p>
				...
				<div class="col col-1of2">
					<ul class="testimonials clearfix">
						...
						<li class="testimonial">
							...
							<div class="testimonial-content">
								<blockquote>
									<p>Our company is very judicious with our marketing dollars. I cannot think of another provider of real-time leads for  CTOs that offers as good a value for our investment. The annual subscription paid for itself in 2 months</p>
		...
		<div class="shell">
			...
			<!--		<li>
					...
					<li>
						...
						<p>The two main deliverables are 1) regular email updates when CTOs change jobs, including their updated emails and 2) full unlimited access to 14,000+ profiles of senior IT executives for searching/browsing/downloading.</p>
					</li>
