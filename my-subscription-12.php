           ...
           <tr>
      		<td align="left" valign="middle" class="registration-page-heading-bg">
				<table width="960" border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<tr>
					  <td align="left" valign="middle" class="my-profile-page-title-text"><a href="<?=HTTP_SERVER?>my-profile.php">My Profile</a>&nbsp;&nbsp;&nbsp;&nbsp;<strong>&nbsp;<a href="<?=HTTP_SERVER?>my-subscription.php">My Subscription&nbsp;</a>&nbsp;</strong>&nbsp;&nbsp;&nbsp;<a href="<?=HTTP_SERVER?>my-alert.php">My Alerts</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?=HTTP_SERVER?>alert.php">Add New Alert</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?=HTTP_SERVER?>my-change-password.php">Change Password</a></td>
					</tr>
      			</table>
			</td>
      	</tr>
				  ...
				  <table width="641" border="0" align="left" cellpadding="0" cellspacing="0">
				  		<tr>
							<td  align="left" valign="top">
								...
								?>
								<div id="sub-level-change" style="display:<? if($divID == 'sub-level-save'){echo 'none';}else{ echo 'block';}?>;">
								...
								<table width="99%" align="left" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="112" align="left" valign="top" <? if($mode=='Edit'){ echo 'class="deactive-button"';}else{ echo 'class="active-button"';}?>>
											<? if($mode!='Edit'){?>
								...
								<div id="sub-level-save" style="display:<? if($divID == 'sub-level-save'){echo 'block';}else{ echo 'none';}?>;">
								...
								<table width="99%" align="left" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="107" align="left" valign="top" <? if($mode=='Edit' && $divID =='sub-level-save' ){ echo 'class="active-button"';}else{ echo 'class="deactive-button"';}?>><a href="javascript:FormValueSubmit('frmSubscriptionLevel');">Save <img src="images/white-arrow-small.gif" width="12" height="9" alt="" title=""  border="0"/></a></td>
									  </tr>
								</table>
								</form>
								</div>
					  	...
					  	<tr>
							<td>
								<div id="sub-status-change" style="display:<? if($divID == 'sub-status-save'){echo 'none';}else{ echo 'block';}?>;">
								<table width="99%" align="left" cellpadding="0" cellspacing="0" border="0">
									<tr>
										...
										<td width="164" align="left" valign="top" class="form-content-text"><? if($subscription_row['status']=='0'){echo 'Active';}else{echo 'Inactive';} ?> </td>
										  <td width="112" align="left" valign="top" <? if($mode=='Edit'){ echo 'class="deactive-button"';}else{ echo 'class="active-button"';}?>>
										  	<? if($mode!='Edit'){?>
								...
								<div id="sub-status-save" style="display:<? if($divID == 'sub-status-save'){echo 'block';}else{ echo 'none';}?>;">
								...
								<table width="99%" align="left" cellpadding="0" cellspacing="0" border="0">
									<tr>
										...
										<td width="164" align="left" valign="top" class="form-content-text">
										  ...
										  <td width="112" align="left" valign="top"  class="deactive-button"><a href="#">Change<img src="images/white-arrow-small.gif" width="12" height="9" alt="" title=""  border="0"/></a></td>
										  <td width="107" align="left" valign="top"  <? if($mode=='Edit' && $divID =='sub-status-save' ){ echo 'class="active-button"';}else{ echo 'class="deactive-button"';}?>><a href="javascript:FormValueSubmit('frmSubscriptionStatus');">Save<img src="images/white-arrow-small.gif" width="12" height="9" alt="" title=""  border="0"/></a></td>
									 </tr>
								</table>
								</form>
								</div>
						...
						<tr>
							<td>
								...
								?>
								<div id="sub-exp-date-change" style="display:<? if($divID == 'sub-exp-date-save'){echo 'none';}else{ echo 'block';}?>;">
								<table width="99%" align="left" cellpadding="0" cellspacing="0" border="0">
									<tr>
										...
										<td width="112" align="left" valign="middle" <? if($mode=='Edit'){ echo 'class="deactive-button"';}else{ echo 'class="active-button"';}?>>
								...
								<div id="sub-exp-date-save" style="display:<? if($divID == 'sub-exp-date-save'){echo 'block';}else{ echo 'none';}?>;">
								...
								<table width="99%" align="left" cellpadding="0" cellspacing="0" border="0">
									<tr>
										...
										<td width="107" align="left" valign="middle"  <? if($mode=='Edit' && $divID =='sub-exp-date-save' ){ echo 'class="active-button"';}else{ echo 'class="deactive-button"';}?>><a href="javascript:FormValueSubmit('frmExpDate');">Save<img src="images/white-arrow-small.gif" width="12" height="9" alt="" title=""  border="0"/></a></td>
									  </tr>
						...
						<tr>
							<td>
								<div id="sub-email-frequency-change" style="display:<? if($divID == 'sub-email-frequency-save'){echo 'none';}else{ echo 'block';}?>;">
								<table width="99%" align="left" cellpadding="0" cellspacing="0" border="0">
								...
								<div id="sub-email-frequency-save" style="display:<? if($divID == 'sub-email-frequency-save'){echo 'block';}else{ echo 'none';}?>;">
								...
								<table width="99%" align="left" cellpadding="0" cellspacing="0" border="0">
									  ...
									  <tr>
										...
										<td width="112" align="left" valign="top"  class="deactive-button"><a href="#">Change<img src="images/white-arrow-small.gif" width="12" height="9" alt="" title=""  border="0"/></a></td>
										<td width="107" align="left" valign="top" <? if($mode=='Edit' && $divID =='sub-email-frequency-save' ){ echo 'class="active-button"';}else{ echo 'class="deactive-button"';}?>><a href="javascript:FormValueSubmit('frmEmailFrequency');">Save<img src="images/white-arrow-small.gif" width="12" height="9" alt="" title=""  border="0"/></a></td>
									  </tr>
								</table>
								</form>
								</div>
						...
						<tr>
							<td>
								...
								<div id="alert-level-change" style="display:<? if($divID == 'alert-level-save'){echo 'none';}else{ echo 'block';}?>;">
								<table width="99%" align="left" cellpadding="0" cellspacing="0" border="0">
									<tr>
								...
								<div id="alert-level-save" style="display:<? if($divID == 'alert-level-save'){echo 'block';}else{ echo 'none';}?>;">
								...
								<table width="99%" align="left" cellpadding="0" cellspacing="0" border="0">
									<tr>
										...
										<td width="164" height="41" align="left" valign="top" class="form-content-text">      
										 ...
										 <td width="112" align="left" valign="top" class="deactive-button"><a href="#">Change<img src="images/white-arrow-small.gif" width="12" height="9" alt="" title=""  border="0"/></a></td>
										<td width="107" align="left" valign="top" <? if($mode=='Edit' && $divID =='alert-level-save' ){ echo 'class="active-button"';}else{ echo 'class="deactive-button"';}?>><a href="javascript:FormValueSubmit('frmAlertLevel');">Save<img src="images/white-arrow-small.gif" width="12" height="9" alt="" title=""  border="0"/></a></td>
									  </tr>
								</table>
								</form>
								</div>
						...
						<tr>
							<td>
								<div id="alert-status-change" style="display:<? if($divID == 'alert-status-save'){echo 'none';}else{ echo 'block';}?>;">
								<table width="99%" align="left" cellpadding="0" cellspacing="0" border="0">
									<tr>
										<td width="258" height="36" align="left" valign="top" class="content-text"><strong>Status:</strong></td>
										<td width="164" align="left" valign="top" class="form-content-text"><? if($alert_row['status']=='0'){echo 'Active';}else{echo 'Inactive';} ?></td>
										<td width="112" align="left" valign="top"  <? if($mode=='Edit'){ echo 'class="deactive-button"';}else{ echo 'class="active-button"';}?>>
											<? if($mode!='Edit'){?>
								...
								<div id="alert-status-save" style="display:<? if($divID == 'alert-status-save'){echo 'block';}else{ echo 'none';}?>;">
									...
									<tr>
										...
										<td width="164" align="left" valign="top" class="form-content-text">
										   ...
										   <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="my_div_small">
												<tr>
												  <td valign="top">
														<input type="text" name="alert_status" id="alert_status" class="text-new-100" value="<? if($alert_row['status']=='0'){echo 'Active';}else{echo 'Inactive';} ?>" style="margin-top:0px; border:0px solid #000000; color:#737373;" onfocus="MyCombo_Open('div_alert_status');fieldHighlightCombo2('alert_status');" onblur="fieldLosslightCombo2('alert_status');" size="13"/>
										...
										<td width="112" align="left" valign="top"  class="deactive-button"><a href="#">Change<img src="images/white-arrow-small.gif" width="12" height="9" alt="" title=""  border="0"/></a></td>
										<td width="107" align="left" valign="top" <? if($mode=='Edit' && $divID =='alert-status-save' ){ echo 'class="active-button"';}else{ echo 'class="deactive-button"';}?>><a href="javascript:FormValueSubmit('frmAlertStatus');">Save<img src="images/white-arrow-small.gif" width="12" height="9" alt="" title=""  border="0"/></a></td>
									  </tr>
								</table>
								</form>
								</div>
						...
						<tr>
							<td>
								...
								$expiry_date = $exp_dt[1]."/".$exp_dt[2]."/".$exp_dt[0];
								?>
								<div id="alert-exp-date-change" style="display:<? if($divID == 'alert-exp-date-save'){echo 'none';}else{ echo 'block';}?>;">
								<table width="99%" align="left" cellpadding="0" cellspacing="0" border="0">
									<tr>
								...
								<div id="alert-exp-date-save" style="display:<? if($divID == 'alert-exp-date-save'){echo 'block';}else{ echo 'none';}?>;">
								...
								<table width="99%" align="left" cellpadding="0" cellspacing="0" border="0">
									<tr>
										...
										<td width="112" align="left" valign="middle" class="deactive-button"><a href="#">Change<img src="images/white-arrow-small.gif" width="12" height="9" alt="" title=""  border="0"/></a></td>
										<td width="107" align="left" valign="middle"  <? if($mode=='Edit' && $divID =='alert-exp-date-save' ){ echo 'class="active-button"';}else{ echo 'class="deactive-button"';}?>><a href="javascript:FormValueSubmit('frmAlertExpDate');">Save<img src="images/white-arrow-small.gif" width="12" height="9" alt="" title=""  border="0"/></a></td>
									</tr>
								</table>
								</form>
								</div>
