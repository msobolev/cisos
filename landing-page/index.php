...
if(isset($_REQUEST["submit"]) && !empty($_POST["email"])){
	...
	$dname=com_db_input($_POST['fname']).' '.com_db_input($_POST['lname']) ;
	$dfrom=com_db_input($email);
	$dmsg=com_db_input($message);
	$add_date = date('Y-m-d');
	com_db_query("insert into " . TABLE_CONTACT_US . " (name,email,message,add_date) values ('$dname','$dfrom','$dmsg','$add_date')");
...
<link href="http://www.ctosonthemove.com/landing-page/css/style.css" rel="stylesheet" type="text/css" />
                ...
                <tr>
				  ...
				  <table width="202" border="0" align="center" cellpadding="2" cellspacing="0">
				   ...
				   <tr>
                    ...
                    <tr>
                      <td align="left" valign="middle"><input name="image" type="image" onMouseOver="this.src='http://www.ctosonthemove.com/landing-page/images/submit-buttn-h.jpg'" onMouseOut="this.src='http://www.ctosonthemove.com/landing-page/images/submit-buttn.jpg'" value="Sign Up" src="http://www.ctosonthemove.com/landing-page/images/submit-buttn.jpg"  alt="Sign Up"/></td>
                    </tr>
                    <tr>
