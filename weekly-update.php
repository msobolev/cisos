...
if($perNumRows > 0){
		  ...
		  while($perRow = com_db_fetch_array($perResult)){
		   ...
		   $table4 = '<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			$personalInfo = '<div class="column" style="padding-left:1px;">';
			for($pp=0;$pp<$totPerson;$pp++){
				$personalInfo .='<div  style="border:0px solid red; width:12.5%; float:left;">
									<div class="img" style="font-size:0pt; line-height:0pt; text-align:left">
										<a href="'.HTTP_SITE_URL.$person_info[$pp]['purl'].'" target="_blank"><img src="'.HTTP_SITE_URL.'personal_photo/small/'.$person_info[$pp]['pimage'].'" alt="" border="0" width="80" height="80" /></a>
									</div>
									<div class="thumb-name" style="color:#ffffff; font-family:Arial; font-size:11px; line-height:17px; text-align:center; background-color:#333333;border-right:1px solid #fff;">'.$person_info[$pp]['pname'].'</div>
									<div style="font-size:0pt; line-height:0pt; height:1px; background:#ffffff; "><img src="'.HTTP_SITE_URL.'images/empty.gif" width="1" height="1" style="height:1px" alt="" /></div>
								 </div>';
			
			}
			$personalInfo .= '</div>';
			$perImgName = $personalInfo;
