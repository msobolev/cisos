				...
				<div class="intro">
					<div class="shell">
						...
						<div class="small-popup">
							...
							<div id="update_alert" class="small-popup-inner" style="display:<? if($mmRow['not_current']=='Yes'){echo 'block';}else{echo 'none';}?>;"><a href="javascript:;" onmouseover="showHideNew('white_content')">Update: This person is no longer there</a></div>
							<div class="small-popup-inner-new"><a href="<?=HTTP_SERVER?>index.php"><img src="css/images/small-logo.png" alt="" width="109" height="23" border="0" title="" /></a></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="content">
				...
				<div class="entry">
					...
					<div class="entry-content">
						...
						$first_name = com_db_output($mmRow['first_name']);
						$last_name = com_db_output($mmRow['last_name']);
						$personURL = com_db_output($mmRow['first_name'].'_'.$mmRow['last_name'].'_Exec_'.$mmRow['personal_id']);
						...
						?>
						<h3 class="company-info"><a href="<?=HTTP_SERVER?><?=com_db_output($mmRow['first_name'].'_'.$mmRow['last_name'].'_Exec_'.$mmRow['personal_id'])?>">About the Person</a></h3>
						<p><?=$about_person;?></p>
					</div>
					<div class="cl">&nbsp;</div>
				</div>
			...
			<div class="info">
				<div class="info-b">
					<div class="info-t">
                        ...
                        <p>How would you like to connect with 15,000+ IT executives in charge of $ millions in IT budgets? <a href="<?=HTTP_SERVER?>pricing.html">Find details here</a>.</p>
					</div>
				</div>
			</div>
			<!-- end Info -->
