...
<body>
	...
	<div id="main">
		...
		<div class="shell-new-inner">
			...
			<div class="step-box">
				<div class="step6">
				  <div class="step-box-heading">Step 1<br />
				    Chose Subscription Level</div>
				</div>
				<div class="step2-active">
					<div class="active-heading">Step 2<br />Submit Payment Details</div>
				</div>
			...
			<div class="step-field-box">
					<div class="fieldsnew1"><div class="fieldsnew2">All fields are required</div></div>
					 <? 
					  ...
					  ?>
					  <form name="frmSubmitPay" id="frmSubmitPay" method="post" action="res-process.php?action=SubmitPaymentAdminUser&amp;res_id=<?=$res_id?>" onsubmit="return SubmitPaymentValidation();" >
