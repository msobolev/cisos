	...
	<div class="section">
		...
		<form method="post" name="frmChooscSub" id="frmChooscSub_one" action="res-price-process.php?action=ChoosePricing">
			...
			<div class="cols-holder">
				...
				<!-- /col -->
				<div class="col professional-offer">
					<div class="col-heading">
						<h6>Professional</h6>
					...
					<div class="col-info">
						<p>
							For enterprise <strong>teams</strong><br />
							<strong>focusing on broad market</strong> with multi-product solutions
						</p>
					</div>
					<!-- /col-info -->
					<div class="col-cnt">
                        <? if(strtolower($professional_email_updates)=='yes'){echo '<span class="check-ico"></span>';}else{echo '<span class="cross-ico"></span>';}?>
						<ul>
							<li><? if(!ctype_digit($professional_search_database)){echo '<strong>'.$professional_search_database.'</strong>';}else{ echo '<strong>'.$professional_search_database.'</strong> searches / month';}?></li>
							<li><? if(!ctype_digit($professional_download_contacts)){echo '<strong>'.$professional_download_contacts.'</strong>';}else{ echo '<strong>'.$professional_download_contacts.'</strong> profiles / month';}?></li>
						</ul>

						<a href="javascript:;" onclick="SubscriptionSelect('<?=$professional_sub_id?>');" class="orange-btn">Get started now</a>
					</div>
					<!-- /col-cnt -->
				</div>
				<!-- /col -->
				...
				<div class="col best-offer">
					...
					<div class="col-info">
						<p>
							For <strong>teams</strong> focusing on <br />
							<strong>aggressively expanding</strong> their target maket
						</p>
					</div>
					<!-- /col-info -->
					<div class="col-cnt">
                        <? if(strtolower($standard_email_updates)=='yes'){echo '<span class="check-ico"></span>';}else{echo '<span class="cross-ico"></span>';}?>
						<ul>
							<li><? if(!ctype_digit($standard_search_database)){echo '<strong>'.$standard_search_database.'</strong>';}else{ echo '<strong>'.$standard_search_database.'</strong> searches / month';}?></li>
							<li><? if(!ctype_digit($standard_download_contacts)){echo '<strong>'.$standard_download_contacts.'</strong>';}else{ echo '<strong>'.$standard_download_contacts.'</strong> profiles / month';}?></li>
						</ul>

						<a href="javascript:;" onclick="SubscriptionSelect('<?=$standard_sub_id?>');" class="orange-btn">Get started now</a>
					</div>
					<!-- /col-cnt -->
				</div>
				<!-- /col -->

				<div class="col basic-offer">
					<div class="col-heading">
						<h6>Basic</h6>
					...
					<div class="col-info">
						<p>
							For niche <strong>players</strong> (focused geo, industry target)
						</p>
					</div>
					<!-- /col-info -->
					<div class="col-cnt">
                        <? if(strtolower($basic_email_updates)=='yes'){echo '<span class="check-ico"></span>';}else{echo '<span class="cross-ico"></span>';}?>
						<ul>
							<li><? if(!ctype_digit($basic_search_database)){echo '<strong>'.$basic_search_database.'</strong>';}else{ echo '<strong>'.$basic_search_database.'</strong> searches / month';}?></li>
							<li><? if(!ctype_digit($basic_download_contacts)){echo '<strong>'.$basic_download_contacts.'</strong>';}else{ echo '<strong>'.$basic_download_contacts.'</strong> profiles / month';}?></li>
						</ul>

						<a href="javascript:;" onclick="SubscriptionSelect('<?=$basic_sub_id?>');" class="orange-btn">Get started now</a>
					</div>
					<!-- /col-cnt -->
				</div>
				<!-- /col -->
