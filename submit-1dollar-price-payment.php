...
function SubmitPaymentValidation(){
		...
		SubmitPaymentButtonOnOff();
	document.getElementById('frmSubmitPay').submit();	
}
function SubmitPaymentButtonOnOff(){
	document.getElementById('one_dollar_submit').style.display="none";
	document.getElementById('one_dollar_submit_gray').style.display="block";
}
</script>
		...
		<div class="shell-new-inner">
			...
			<!-- step box -->
			  <div class="step-box">
				  <div class="step1-active ">
				  	<div class="active-heading">Step 1<br />Submit Payment Details</div>
				  </div>
			  
				  <div class="step2">
					<div class="step-box-heading">Step 2<br />Provide Contact Information</div>
				  </div>
				  <div class="step3">
			...
			<div class="step-field-box">
					 ...
					 <? 
					  ...
					  ?>
					  <form name="frmSubmitPay" id="frmSubmitPay" method="post" action="res-1dollar-price-process.php?action=SubmitPaymentPrice" onsubmit="return SubmitPaymentValidation();" >
						<div class="inner-field-box-submit">
                            ...
                            <a href="paypal_process_1dollar.php"><img src="css/images/paypal.gif" alt="PayPal" border="0" /></a>
					    </div>
							...
							<table width="540" border="0" align="center" cellpadding="0" cellspacing="0">
							  ...
							  <tr>
								...
								<div class="name-field-box">Billing Address :
									...
									<input type="hidden" name="startDate" id="startDate" size="35" value="<?=date('d/m/Y',mktime(0, 0, 0, date("m") , date("d"), date("Y")));?>" />
								</div>
							...
							<div class="buttn-box">
								<div class="blue-buttn">
                                	<div id="one_dollar_submit" style="display:block;">
                            		<input type="image" name="pay_submit"  src="css/images/confirm.jpg" />
                                    </div>
                                    <div id="one_dollar_submit_gray" style="display:none;">
                                    <img src="css/images/confirm-gray.gif" width="136" height="45" alt="" title="">
                                    </div>
                                </div>
							</div>	
					</div>
