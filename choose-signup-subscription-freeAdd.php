...
if($full_name !='' && $email !=''){
	...
	$emailPresent = com_db_GetValue("select user_id from ".TABLE_USER." where email ='".$email."'");
	if($emailPresent == ''){
		$res_query = "insert into " . TABLE_USER . " (first_name,last_name,company_name,email,password,subscription_id,level,exp_date,res_date) values ('$first_name','$last_name','$company_name','$email','$password','1','Free','$exp_date','$add_date')";
...
<head>
	...
	<script type="text/javascript" language="javascript">
		function SubscriptionSelect(div_id){
			if(div_id=='DivFree'){
				document.getElementById('DivFree').className="left4_select";
			...
			}else if(div_id=='DivBasic'){
				document.getElementById('DivFree').className="left4";
				...
				<td align="left" valign="top">
					<!--<div class="headernew-repeat1">
						<div class="arrow-left1">
							<div class="new-arrowbg6">Step 1<br />
						...
						<div class="arrow-left1">
							<div class="new-arrowbg2">Step 3<br />
					...
					<div class="headernew-repeat1">
						<div class="arrow-left1">
							<div class="new-arrowbg5">Step 1<br />
							Provide Contact Information</div>
						</div>
						<div class="arrow-left1">
							<div class="new-arrowbg3">Step 2<br />
							Chose Subscription Level</div>
						</div>
						<div class="arrow-left1">
							<div class="new-arrowbg2">Step 3<br />
			...
			<!-- step box -->
				...
				<!--<div class="step-box">
				  <div class="step1-active ">
				  	<div class="active-heading">Step 2<br />Chose Subscription Level</div>
				  </div>
			  
				  <div class="step2">
					<div class="step-box-heading">Step 3<br />Submit Payment Details</div>
				  </div>
				  <div class="step3">
				...
				<!--<div class="step-box">
					  ...
					  <div class="step5">
					   <div class="step-box-heading">Step 3<br />
						 Submit Payment Details</div>
					  </div>
				</div>-->
			<!-- step box -->
					...
					<div>
						<div class="pagerepeat">
							<div class="left1">
								...
								<?
								   ...
								   ?>
									<div class="left3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
									  ...
									  <tr>
										<td height="51" align="left" valign="middle" class="top-border text3"><!--Download Contacts&nbsp; <img src="css/images/question.png" alt="" />-->
									...
									<div id="DivFree" class="left4">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
										  ...
										  <tr>
											<td height="51" align="center" valign="middle" class="top-border"><? if(!ctype_digit($free_download_contacts)){echo $free_download_contacts;}else{ echo $free_download_contacts.' profiles / month';}?></td>
										  </tr>
									...
									<div id="DivBasic" class="left4">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
										  ...
										  <tr>
											<td height="51" align="center" valign="middle" class="top-border"><? if(!ctype_digit($basic_download_contacts)){echo $basic_download_contacts;}else{ echo $basic_download_contacts.' profiles / month';}?></td>
										  </tr>
									...
									<div id="DivStandard" class="left4 left4_select">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
										  ...
										  <tr>
											<td height="51" align="center" valign="middle" class="top-border"><? if(!ctype_digit($standard_download_contacts)){echo $standard_download_contacts;}else{ echo $standard_download_contacts.' profiles / month';}?></td>
										  </tr>
									...
									<div id="DivProfessional" class="left4">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
										  ...
										  <tr>
											<td height="51" align="center" valign="middle" class="top-border"><? if(!ctype_digit($professional_download_contacts)){echo $professional_download_contacts;}else{ echo $professional_download_contacts.' profiles / month';}?></td>
										  </tr>
								...
								<div class="chose chose-new-text1"><table width="100%" border="0" cellspacing="0" cellpadding="0">
								  <tr>
									...
									<td align="center" valign="middle"><input type="radio" name="radio_sub_id" value="<?=$professional_sub_id?>" onclick="SubscriptionSelect('DivProfessional')" class="redio-button"/></td>
								  </tr>
								</table>
								</div>
							</div>
						  <div class="left2">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
								  ...
								  <tr>
									<td align="left" valign="top" class="padding1"><p class="padding2">If you are not fully satisfied by our service and let us know within 30 days of signing up we will <span class="text4">fully refund your subscription fee</span>, no questions asked!</p>
