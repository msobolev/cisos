...
$mID = (isset($_GET['mID']) ? $_GET['mID'] : $select_data[0]);
    ...
    switch ($action) {
	  ...
	  case 'edit':
			...
			//$ann_dt = explode("-",$data_edit['announce_date']);
			//$announce_date = $ann_dt[1].'/'.$ann_dt[2].'/'.$ann_dt[0];
     ...
     <div id="light" class="white_content" style="display:<? if($action=='MovementSearch'){ echo 'block';} else { echo 'none'; } ?>;">
		...
		<table width="90%" border="0" align="center" cellpadding="1" cellspacing="1">
		  ...
		  <tr>
			...
			<td align="left" valign="top"><select name="search_company_id" id="search_company_id" style="width:208px;">
          ...
          <tr><td colspan="2">&nbsp;</td></tr>
		  <tr>
			<td align="left" valign="top" >Person Name:</td>
			<td align="left" valign="top"><select name="search_personal_id" id="search_personal_id" style="width:208px;">
			  <option value="">--Select Person Name--</option>
			  <?=selectComboBox("select personal_id,concat(first_name,' ',last_name) as full_name from ".TABLE_PERSONAL_MASTER." where status=0 order by first_name, last_name",'')?>
		    </select></td>
		  </tr>
          <tr><td colspan="2">&nbsp;</td></tr>
		  <tr>
