...
$pID = (isset($_GET['pID']) ? $_GET['pID'] : $select_data[0]);
    ...
    switch ($action) {
	  ...
	  case 'edit':
		...
		case 'editsave':
			...
			awards_title = '".$awards_title."', awards_given_by = '".$awards_given_by."', awards_date = '".$awards_date."', modify_date = '".$modify_date."',create_by='".$create_by."',admin_id='".$login_id."' where personal_id = '" . $pID . "'";
			com_db_query($query);
	...
	case 'addsave':
			...
			edu_ugrad_specialization, edu_ugrad_college, edu_ugrad_year, edu_grad_degree ,edu_grad_specialization ,edu_grad_college, edu_grad_year,awards_title,awards_given_by,awards_date,add_date, create_by,admin_id, status) 
			...
			'$edu_ugrad_specialization','$edu_ugrad_college','$edu_ugrad_year','$edu_grad_degree','$edu_grad_specialization','$edu_grad_college','$edu_grad_year','$awards_title','$awards_given_by','$awards_date','$add_date','$create_by','$login_id','$status')";
			com_db_query($query);
	...
	<div id="light" class="white_content" style="display:<? if($action=='PersonalSearch'){ echo 'block';} else { echo 'none'; } ?>;">
		...
		<table width="80%" border="0" align="center" cellpadding="1" cellspacing="1">
		  ...
		  <!--<tr>
			...
			<td align="left" valign="top"><input name="search_title" id="search_title" /></td>
		  </tr>-->
		  <tr>
		 ...
		 <form name="frmDataEdit" id="frmDataEdit" method="post" enctype="multipart/form-data" action="personal-master.php?action=editsave&selected_menu=personal&pID=<?=$pID;?>&p=<?=$p;?>" onsubmit="return chk_form();">
            ...
            <tr>
			  <td align="left">
                    ...
                    <!--<tr>
                      ...
                      <td width="75%" align="left" valign="top"><input type="text" name="title" id="title" size="30" value="<?//=$title?>" /> </td>	
                    </tr>-->
                    <tr>
                   ...
                   <!-- <tr>
                      ...
                      <td width="75%" align="left" valign="top"><input type="text" name="contact_url" id="contact_url" size="30" value="<?//=$contact_url?>" /> </td>	
                    </tr>-->
                    <tr>
            ...
            <tr>
			  <td align="left">
              	  <table width="100%" cellpadding="2" cellspacing="2" border="0">
                    <tr>
                      <td width="25%" align="left" class="page-text" valign="top">Award Title:</td>
                      <td width="75%" align="left" valign="top"><input type="text" name="awards_title" id="awards_title" size="30" value="<?=$awards_title?>" /> </td>	
                    </tr>
                    <tr>
                      <td width="25%" align="left" class="page-text" valign="top">Award Given By:</td>
                      <td width="75%" align="left" valign="top"><input type="text" name="awards_given_by" id="awards_given_by" size="30" value="<?=$awards_given_by?>" /> </td>	
                    </tr>
                    <tr>
                      <td width="25%" align="left" class="page-text" valign="top">Award Date:</td>
		 ...
		 <form name="DateTest" method="post" enctype="multipart/form-data" action="personal-master.php?action=addsave&selected_menu=personal&pID=<?=$pID;?>&p=<?=$p;?>" onsubmit="return chk_form_Add();">
		  <table width="95%" align="left" cellpadding="5" cellspacing="5" border="0">
           ...
           <!-- <tr>
			  ...
			  <td align="left">
                    ...
                    <tr>
                      ...
                      <td width="75%" align="left" valign="top">
                      	<select name="company_id" id="company_id" style="width:208px;" onchange="AddCompanyInformation('company_id');">
            ...
            <tr>
			  <td align="left">
              		<div id="DivCompanyInformationShow"></div>
              </td>	
			</tr>-->
            <tr>
			  <td align="left" class="heading-text-a">>>Social Media</td>	
            ...
            <tr>
			  <td align="left">
                    ...
                    <tr>
                      <td width="25%" align="left" class="page-text" valign="top">Award Title:</td>
                      <td width="75%" align="left" valign="top"><input type="text" name="awards_title" id="awards_title" size="30" value="" /> </td>	
                    </tr>
                    <tr>
                      <td width="25%" align="left" class="page-text" valign="top">Award Given By:</td>
                      <td width="75%" align="left" valign="top"><input type="text" name="awards_given_by" id="awards_given_by" size="30" value="" /> </td>	
                    </tr>
                    <tr>
                      <td width="25%" align="left" class="page-text" valign="top">Award Date:</td>
                      <td width="75%" align="left" valign="top"><input type="text" name="awards_date" id="awards_date" size="30" value="" />&nbsp;<a href="javascript:NewCssCal('awards_date','mmddyyyy','arrow')"><img src="images/calender-icon.gif" alt="" width="22" height="14" border="0" title="" /></a></td>	
                    </tr>
                  </table>
              </td>	
			</tr>
		 ...
		 <!--start iner table  -->
            ...
            <tr>
			  <td align="left">
                    ...
                    <tr>
                      <td width="25%" align="left" class="page-text" valign="top">Award Title:</td>
                      <td width="75%" align="left" valign="top"><?=$awards_title?></td>	
                    </tr>
                    <tr>
                      <td width="25%" align="left" class="page-text" valign="top">Award Given By:</td>
                      <td width="75%" align="left" valign="top"><?=$awards_given_by?></td>	
                    </tr>
                    <tr>
                      <td width="25%" align="left" class="page-text" valign="top">Award Date:</td>
