...
$pID = (isset($_GET['pID']) ? $_GET['pID'] : $select_data[0]);
    ...
    switch ($action) {
		...
		case 'editsave':
			com_db_query("update " . TABLE_POPUP_ONOFF . " set status='".$_POST['popup_status']."' where id='".$pID."'");
          ...
          <tr>
			...
			?>          
			  <tr>
				...
				<td height="30" align="left" valign="middle" class="right-border-text">Status : <? if ($data_sql['status']=='On'){ echo 'On';}else{ echo 'Off';} ?></td>
...
<?php } elseif($action=='edit'){ ?>	
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		 ...
		 <!--start iner table  -->
			...
			<tr>
			  <td width="11%" align="left" class="page-text" valign="top">&nbsp;&nbsp;&nbsp;Status  :</td>
			  <td width="89%" align="left" valign="top" class="page-text">
