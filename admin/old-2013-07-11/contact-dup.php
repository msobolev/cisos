...
if($url_result){
	while($url_row = com_db_fetch_array($url_result)){
		...
		//$contact_url = strtolower(preg_replace(array('/[^a-zA-Z0-9 -]/', '/[ -]+/', '/^-|-$/'), array('', '-', ''), $contact_url));
...
$cID = (isset($_GET['cID']) ? $_GET['cID'] : $select_data[0]);
    ...
    switch ($action) {
	  ...
	  case 'edit':
		...
		case 'editsave':
			...
			$isPresent = com_db_GetValue("select contact_id from ".TABLE_CONTACT." where (first_name='".$first_name."' and last_name='".$last_name."' and new_title='".$new_title."' and company_name='".$company_name."') and contact_id!='".$cID."'");
			if($isPresent >0){
				com_redirect("contact.php?action=edit&p=" . $p . "&cID=".$cID."&msg=" . msg_encode("$first_name $last name, $new_title, $company_name contact already present"));
			}else{
				...
				contact_url = '".$contact_url."', company_name = '" . $company_name ."', company_website = '".$company_website."', company_revenue = '".$company_revenue."', company_employee = '".$company_employee."', company_industry = '".$company_industry."',  ind_group_id = '".$ind_group_id."', industry_id = '".$industry_id."',
	...
	case 'addsave':
			...
			$status = '0';
			$add_date = date('Y-m-d');
			$isPresent = com_db_GetValue("select contact_id from ".TABLE_CONTACT." where first_name='".$first_name."' and last_name='".$last_name."' and new_title='".$new_title."' and company_name='".$company_name."'");
			if($isPresent >0){
				com_redirect("contact.php?p=" . $p . "&selected_menu=contact&msg=" . msg_encode("$first_name $last name, $new_title, $company_name contact already present"));
			}else{
				$query = "insert into " . TABLE_CONTACT . "
				(first_name, middle_name, last_name, new_title, email, phone, company_name, contact_url, company_website, company_revenue, company_employee, company_industry, ind_group_id, industry_id, address, address2, city, state, country, zip_code, announce_date, effective_date, source, headline, full_body,short_url, movement_type, what_happened,about_person, about_company, more_link, add_date, publish,create_by, status) 
...
<?php if(($action == '') || ($action == 'save') || ($action =='ContactSearch') || $action =='ContactSearchResult'){	?>			
          ...
          <tr>
			...
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
			  <tr>
				...
				<td width="39" height="30" align="center" valign="middle" class="right-border">
				...
				<td width="144" height="30" align="center" valign="middle" class="right-border"><span class="right-box-title-text">Effective Date</span> </td>
                <td width="192" height="30" align="center" valign="middle" class="left-border"><div align="center"><span class="right-box-title-text">Action</span></div></td>
			  </tr>
			<?php
			  ...
			  <tr>
				...
				<td height="30" align="center" valign="middle" class="left-border">
					<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
					  <tr> 
					  	<?php if($status==0){ ?>
					   	<td width="29%" align="center" valign="middle"><a href="#"><img src="images/icon/active-icon.gif" width="16" height="16" alt="" title="" border="0" onclick="confirm_artivate('<?=$data_sql['contact_id'];?>','<?=$p;?>','<?=$status;?>');" /></a><br />
					   	  Status</td>
					   	<?php } elseif($status==1){ ?>
					   	<td width="24%" align="center" valign="middle"><a href="#"><img src="images/icon/inactive-icon.gif" width="16" height="16" alt="" title="" border="0" onclick="confirm_artivate('<?=$data_sql['contact_id'];?>','<?=$p;?>','<?=$status;?>');" /></a><br />
					   	  Status</td>
						<?php } ?>
						<td width="23%" align="center" valign="middle"><a href="#"><img src="images/small-edit-icon.gif" width="16" height="16" alt="Edit" title="Edit" border="0" onclick="window.location='contact.php?selected_menu=contact&p=<?=$p;?>&cID=<?=$data_sql['contact_id'];?>&action=edit'" /></a><br />
						  Edit</td>
						<td width="24%" align="center" valign="middle"><a href="#"><img src="images/small-delet-icon.gif" width="16" height="16" alt="Delete" title="Delete" border="0" onclick="confirm_del('<?=$data_sql['contact_id'];?>','<?=$p;?>')" /></a><br />
						  Delete</td>
					  </tr>
					</table>				</td>
         	</tr> 
    ...
    <td align="center" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="666" align="right" valign="top"><table width="200" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
		<?php echo number_pages($main_page, $p, $total_data, 8, $items_per_page,'&selected_menu=contact');?>		  
          </tr>
        </table></td>
...
function chk_form(){
	var fname=document.frmContactEdit.firstname.value;
	
	if(fname==''){
		alert("Please enter first name.");
		document.frmContactEdit.firstname.focus();
		return false;
	}
	var lname=document.frmContactEdit.lastname.value;
	if(lname==''){
		alert("Please enter last name.");
		document.frmContactEdit.lastname.focus();
		return false;
	}
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		 ...
		 <!--start iner table  -->
		 <form name="frmContactEdit" method="post" action="contact.php?action=editsave&selected_menu=contact&cID=<?=$cID;?>&p=<?=$p;?>" onsubmit="return chk_form();">
              	...
              	<div id="div_executive" style="display:none;">
                    ...
                    <tr>
                      ...
                      <td width="75%" align="left" valign="top">
                        <input type="text" name="first_name" id="firstname" size="30" value="<?=$first_name;?>" />
                      </td>	
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td width="75%" align="left" valign="top">
                        <input type="text" name="last_name" id="lastname" size="30" value="<?=$last_name;?>" />
                      </td>	
                    </tr>
                    <tr>
			  ...
			  <td align="left">
              	<div id="div_contact_details" style="display:none;">
					...
					<tr>
                      ...
                      <td width="75%" align="left" valign="top">
                        <input type="text" name="contact_url" id="contact_url" size="30" value="<?=$contact_url?>" />
                      </td>	
                    </tr>
                  </table>
                  </div>
              	...
              	<div id="div_change_details" style="display:none;">
                    ...
                    <tr>
                      ...
                      <td width="75%" align="left" valign="top">
						...
						<textarea name="headline" id="headline" style="width:205px;height:18px;"><?=$headline;?></textarea>
                      </td>	
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td width="75%" align="left" valign="top">
                        <!--<input type="text" name="what_happened" id="what_happened" size="30" value="" />-->
                      	<textarea name="what_happened" id="what_happened" style="width:205px;height:18px;"><?=$what_happened;?></textarea>
					  </td>	
                    </tr>
                    <tr>
                      ...
                      <td width="75%" align="left" valign="top">
						...
						<textarea name="about_person" id="about_person" style="width:205px;height:18px;"><?=$about_person;?></textarea>
                      </td>	
                    </tr>
                    <tr>
                      ...
                      <td width="75%" align="left" valign="top">
						...
						<textarea name="about_company" id="about_company" style="width:205px;height:18px;"><?=$about_company;?></textarea>
                      </td>	
                    </tr>
                    <tr>
            ...
            <tr>
            	<td align="center">
                	<table width="50%" border="0" cellpadding="4" cellspacing="4">
                    	<tr><td><input type="submit" value="Update Contact" class="submitButton" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" class="submitButton" value="cancel" onclick="window.location='contact.php?p=<?=$p;?>&uID=<?=$uID;?>&selected_menu=contact'" /></td></tr>
                    </table>
                </td>
             </tr>
            ...
            <tr>
			  <td align="left">
					...
					<tr>
                      <td width="25%" align="left" class="page-text" valign="top">&nbsp;&nbsp;&nbsp;Contact URL:</td>
                      <td width="75%" align="left" valign="top">
                        <input type="text" name="contact_url" id="contact_url" size="30" value="" />
                      </td>	
                    </tr>
                  </table>
              </td>	
