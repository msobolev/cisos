...
//User
$total_user = com_db_GetValue("select count(user_id) from " . TABLE_USER);
$total_user_active = com_db_GetValue("select count(user_id) from " . TABLE_USER ." where status ='0'");
$total_user_inactive = com_db_GetValue("select count(user_id) from " . TABLE_USER ." where status ='1'");
...
//Contact
$total_contact = com_db_GetValue("select count(contact_id) from " . TABLE_CONTACT);
$total_contact_active = com_db_GetValue("select count(contact_id) from " . TABLE_CONTACT ." where status ='0'");
$total_contact_inactive = com_db_GetValue("select count(contact_id) from " . TABLE_CONTACT ." where status ='1'");
 ...
 <tr>
	...
	<table width="975" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="769" align="center" valign="top"><table width="733" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
          ...
          <tr>
            <td align="left" valign="top"><table width="733" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="314" align="left" valign="top"><table width="314" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center" valign="middle" class="small-box-heading-bg"><table width="280" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td width="174" align="right" valign="middle" class="title-text">LATEST USER POST </td>
                            <td width="44" align="right" valign="middle"><img src="images/red-box.jpg" width="26" height="27"   alt="" title="" /></td>
                          </tr>
                      </table></td>
                    </tr>
                    <tr>
                      <td align="center" valign="top" class="small-box-border"><table width="280" border="0" align="center" cellpadding="4" cellspacing="0">
                          <tr>
                            <td width="146" align="left" valign="middle">&nbsp;</td>
                            <td width="118" align="left" valign="middle">&nbsp;</td>
                          </tr>
                          <tr>
                            <td align="left" valign="middle" class="small-box-heading-text"><b>User  inventory:</b></td>
                            <td align="left" valign="middle">&nbsp;</td>
                          </tr>
                          <tr>
                            <td align="left" valign="middle" class="small-box-heading-text">Total:</td>
                            <td align="left" valign="middle"><?=$total_user;?></td>
                          </tr>
                          <tr>
                            <td align="left" valign="middle" class="small-box-heading-text">Active:</td>
                            <td align="left" valign="middle"><?=$total_user_active;?></td>
                          </tr>
                         <tr>
                            <td align="left" valign="middle" class="small-box-heading-text">Disabled:</td>
                            <td align="left" valign="middle"><?=$total_user_inactive;?></td>
                          </tr>
                ...
                <td width="384" align="left" valign="top"><table width="384" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center" valign="middle" class="big-box-heading-bg"><table width="348" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="18" align="left" valign="middle" class="heading-text"><img src="images/blue-down-arrow.jpg" width="12" height="7"   alt="" title="" /></td>
                            <td width="174" align="right" valign="middle" class="title-text">LATEST TAXONOMIES</td>
                            <td width="44" align="right" valign="middle"><img src="images/folder-icon.jpg" width="23" height="28"   alt="" title="" /></td>
                          </tr>
                      </table></td>
                    </tr>
                    <tr>
                      <td align="center" valign="top" class="small-box-border"><table width="350" border="0" align="center" cellpadding="4" cellspacing="0" >
                          ...
                          <tr>
                            <td width="185" align="left" valign="middle" class="small-box-heading-text"><b>Taxonomies inventory:</b></td>
                            <td width="149" align="left" valign="middle" class="small-box-heading-text"><b><u></u></b></td>
                          </tr>
                          
						  
						  <tr>
                          <td align="left" valign="middle" class="small-box-heading-text">Total:</td>
                          <td align="left" valign="middle" class="small-box-heading-text"><?=$total_contact;?></td>
                         </tr>
                       
                        <tr>
                          <td align="left" valign="middle" class="small-box-heading-text">Active:</td>
                          <td align="left" valign="middle" class="small-box-heading-text"><?=$total_contact_active;?></td>
                        </tr>
                        <tr>
                          <td align="left" valign="middle" class="small-box-heading-text">Disabled:</td>
                          <td align="left" valign="middle" class="small-box-heading-text"><?=$total_contact_inactive;?></td>
                        </tr>
						  ...
						  <!--<tr>
                            <td align="left" valign="middle" class="small-box-heading-text"><b>Articles inventory:</b></td>
                            <td align="left" valign="middle" class="small-box-heading-text"><b><u></u></b></td>
                          </tr>
                          <tr>
                            <td align="left" valign="middle" class="small-box-heading-text">Total:</td>
                            <td align="left" valign="middle" class="small-box-heading-text"><?=$total_articles;?></td>
                          </tr>
                          <tr>
                            <td align="left" valign="middle" class="small-box-heading-text">Active:</td>
                            <td align="left" valign="middle" class="small-box-heading-text"><?=$total_articles_active;?></td>
                          </tr>
						  <tr>
                            <td align="left" valign="middle" class="small-box-heading-text">Disabled:</td>
                            <td align="left" valign="middle" class="small-box-heading-text"><?=$total_articles_inactive;?></td>
                          </tr>-->
                         <!-- <tr>
                            <td align="left" valign="middle" class="small-box-heading-text"><b>Affiliates:</b></td>
                            <td align="left" valign="middle" class="small-box-heading-text"><b><u>1</u></b></td>
                          </tr>
                          <tr>
                            <td align="left" valign="middle" class="top-border-new"><img src="images/spacer.gif" width="1" height="2" alt="" title="" /></td>
                            <td align="left" valign="middle" class="top-border-new"><img src="images/spacer.gif" width="1" height="2" alt="" title="" /></td>
                          </tr>
                          <tr>
                            <td align="left" valign="middle" class="small-box-heading-text"><b>Total:</b></td>
                            <td align="left" valign="middle" class="small-box-heading-text"><b><u>4</u></b></td>
                          </tr>
                          <tr>
                            <td align="left" valign="middle" class="small-box-heading-text">Disabled:</td>
                            <td align="left" valign="middle" class="small-box-heading-text"><u>0</u></td>
                          </tr> -->
                          <tr>
                            <td align="left" valign="middle">&nbsp;</td>
                            <td align="left" valign="middle">&nbsp;</td>
