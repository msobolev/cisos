			  ...
			  <td align="left">
              	<div id="div_contact_details" style="display:block;">
					...
					<tr>
					  ...
					  <td align="left" valign="top"><input type="text" name="lin_url" id="lin_url" size="30" value="<?=$lin_url?>" /></td>
					  </tr>
                  </table>
                  </div>
              </td>	
              	...
              	<div id="div_change_details" style="display:block;">
                    ...
                    <tr>
                      ...
                      <td colspan="2" align="left" valign="top">
                        <?php
						$oFCKeditor = new FCKeditor('what_happened') ;
						$oFCKeditor->BasePath	= $sBasePath ;
						$oFCKeditor->ToolbarSet = ''; // Basic
						$oFCKeditor->Width  = '100%';
						$oFCKeditor->Height  = '250';       
						$oFCKeditor->Value	= $what_happened;
						$oFCKeditor->Create() ;
						?>
					  </td>
                     </tr>
                     <tr>
                     	<td colspan="2">&nbsp;</td> 
                        <td width="24%" align="left" class="MsgShowText" valign="middle"><div id="div_what_happened"></div></td>	
                    </tr>
                    <tr>
                      <td width="26%" align="left" class="page-text" valign="top">&nbsp;&nbsp;&nbsp;About the Person?*:</td>
                      <td colspan="2" align="left" valign="top">
                        <?php
						$oFCKeditor = new FCKeditor('about_person') ;
						$oFCKeditor->BasePath	= $sBasePath ;
						$oFCKeditor->ToolbarSet = ''; // Basic
						$oFCKeditor->Width  = '100%';
						$oFCKeditor->Height  = '250';       
						$oFCKeditor->Value	= $about_person;
						$oFCKeditor->Create() ;
						?>
                      </td>
                    </tr>
                    <tr> 
                      <td colspan="2">&nbsp;</td>  
                      <td width="24%" align="left" class="MsgShowText" valign="middle"><div id="div_about_person"></div></td>		
                    </tr>
                    <tr>
                      <td width="26%" align="left" class="page-text" valign="top">&nbsp;&nbsp;&nbsp;About the Company?*:</td>
                      <td colspan="2" align="left" valign="top">
						<?php
						$oFCKeditor = new FCKeditor('about_company') ;
						$oFCKeditor->BasePath	= $sBasePath ;
						$oFCKeditor->ToolbarSet = ''; // Basic
						$oFCKeditor->Width  = '100%';
						$oFCKeditor->Height  = '250';       
						$oFCKeditor->Value	= $about_company;
						$oFCKeditor->Create() ;
						?>
                      </td>
                     </tr>
                    <tr>
                      <td colspan="2">&nbsp;</td>	  	
                      <td width="24%" align="left" class="MsgShowText" valign="middle"><div id="div_about_company"></div></td>	
                    </tr>
                    <tr>
