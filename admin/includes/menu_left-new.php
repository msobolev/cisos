        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td align="center" valign="middle"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                     ...
                     <table width="167" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="left" valign="middle"><a href="javascript:ShowMenu('company-master.php','master');" class="heading-text-a">Company Master Data</a></td>
		 ...
		 <tr>
		  ...
		  <? }elseif($_SESSION['login_access_type']=='User'){ ?>
          <tr>
            <td align="left" valign="top">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <?php 
                  ...
                  <tr>
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                         <td align="center" valign="middle" <? if($main_menu==1){echo 'class="left"';}else{echo 'class="left-box-text-heading-bg"';} ?>>
                             <table width="167" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr>
