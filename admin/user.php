...
function PaymentClose(pi){
 ...
 <tr>
	...
	<div id="light" class="white_content" style="display:<?PHP if($action=='UserSearch'){ echo 'block';} else { echo 'none'; } ?>;">
	...
	<div id="fade" class="black_overlay" style="display:<?PHP if($action=='UserSearch'){ echo 'block';} else { echo 'none'; } ?>;"></div>
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		 ...
		 <!--start iner table  -->
			...
			<tr>
			  ...
			  <td width="78%" align="left" valign="top" class="page-text">
			  	<input type="radio" name="sub_status" <?PHP if($sub_status=='0'){echo 'checked="checked"';}?> value="0" />Active <br /><input type="radio" name="sub_status" <?PHP if($sub_status=='1'){echo 'checked="checked"';}?> value="1"/>Not Active
			  </td>	
			</tr>
			<tr>
			  <td width="22%" align="left" class="page-text" valign="top">&nbsp;&nbsp;&nbsp;Subscription level:</td>
			  <td width="78%" align="left" valign="top" class="page-text">
			  	<input type="radio" name="subscription_id" <?PHP if($subscription_id=='1'){echo 'checked="checked"';}?> value="1" />Free <br />
				<input type="radio" name="subscription_id" <?PHP if($subscription_id=='2'){echo 'checked="checked"';}?> value="2" />Basic<br />
				<input type="radio" name="subscription_id" <?PHP if($subscription_id=='3'){echo 'checked="checked"';}?> value="3" />Standard<br />
				<input type="radio" name="subscription_id" <?PHP if($subscription_id=='4'){echo 'checked="checked"';}?> value="4" />Professional
			  </td>	
			</tr>
		 ...
		 <!-- end inner table -->
			...
			<tr>
				<td style="padding:15px 5px 15px 25px;">
					<input type="button" class="submitButton" value="Generate Invoice" onclick="window.location='invoice-settings.php?p=<?=$p;?>&iID=<?=$uID;?>&selected_menu=user&action=edit'" />
					&nbsp;&nbsp;&nbsp;
					<input type="button" class="submitButton" value="Set Invoice Static Settings" onclick="window.location='invoice-static-settings.php?p=<?=$p;?>&selected_menu=user&action=edit'" />
				</td>
			</tr>
			  ...
			  <table width="673" border="0" align="center" cellpadding="0" cellspacing="0" >
				...
				<tr>
				  ...
				  <table width="490" border="0" align="center" cellpadding="2" cellspacing="0">
					  <tr>
						...
						<td width="278" align="left" valign="middle"><input name="title" type="text" id="title" size="46" value="<?PHP if($title==''){echo 'Type in the Title';}else{echo $title;}?>" class="list-field" onfocus=" if (this.value == 'Type in the Title') { this.value = ''; };" onblur="if (this.value == '') { this.value='Type in the Title';};"/>
					    </td>
					  </tr>
					  <tr>
						...
						<td width="278" align="left" valign="middle">
							<select name="management" id="management" style="width:300px;">
								...
								<?=selectComboBox("select id,name from ".TABLE_MANAGEMENT_CHANGE." where id in (1,2,6) order by name",'')?>
							</select>	
				...
				<tr>
				  <td align="center" valign="middle"><table width="490" border="0" align="center" cellpadding="2" cellspacing="0">
					...
					<tr>
					  <td width="232" height="27" align="left" valign="top">State:</td>
					  <td width="251"  align="left" valign="top">
					  	<select name="state[]" id="state" multiple="multiple" style="width:300px;">
							<option value="">Any</option>
					...
					<tr>
					  ...
					  <td width="251" height="27" align="left" valign="middle"><input name="city" type="text" id="city" size="46" value="<?PHP if($city==''){echo 'Type in the City';}else{echo $city;}?>" class="list-field" onfocus=" if (this.value == 'Type in the City') { this.value = ''; };" onblur="if (this.value == '') { this.value='Type in the City';};"/></td>
					</tr>
					<tr>
					  <td width="232" height="27" align="left" valign="middle" class="list-field-text">Zip Code: </td>
					  <td width="251" height="27" align="left" valign="middle"><input name="zip_code" type="text" id="zip_code" size="46" value="<?PHP if($zip_code==''){echo 'Type in the Zip code';}else{echo $zip_code;}?>" class="list-field" onfocus=" if (this.value == 'Type in the Zip code') { this.value = ''; };" onblur="if (this.value == '') { this.value='Type in the Zip code';};"/></td>
					</tr>
				  </table></td>
				</tr>
				...
				<tr>
				  <td align="center" valign="middle"><table width="490" border="0" align="center" cellpadding="2" cellspacing="0">
					<tr>
					  ...
					  <td width="247" height="27" align="left" valign="middle"><input name="company" type="text" id="company" size="46" value="<?PHP if($company==''){echo 'Type in the Company Name';}else{echo $company;}?>" class="list-field" onfocus=" if (this.value == 'Type in the Company Name') { this.value = ''; };AllComboDivCloseAlert('');fieldHighlight('company');" onblur="if (this.value == '') { this.value='Type in the Company Name';};fieldLosslight('company');"/></td>
					</tr>
					<tr>
					  <td width="232" height="27" align="left" valign="top">Industry:</td>
					  <td width="247"  align="left" valign="top">
					  	<?php
						$industry_result = com_db_query("select * from " . TABLE_INDUSTRY ." where status=0 and parent_id = '0' order by industry_id");
						?>
						<select name="industry[]" id="industry" multiple="multiple" style="width:300px;">
							<option value="">Any</option>
							<?php
							while($indus_row = com_db_fetch_array($industry_result)){
							?>
							<optgroup label="<?=$indus_row['title']?>">
							<?=selectComboBox("select industry_id,title from ". TABLE_INDUSTRY ." where status=0 and parent_id ='".$indus_row['industry_id']."'" ,'');?>
							</optgroup>
							<?PHP } ?>
						</select>
					  </td>
					...
					<tr>
					  <td width="232" height="27" align="left" valign="top">Size ($Revenue):</td>
					  <td width="247"  align="left" valign="top">
					  	   <select name="revenue_size[]" id="revenue_size" multiple="multiple" style="width:300px;">
								<option value="">Any</option>
								<?=selectComboBox("select id,name from ".TABLE_REVENUE_SIZE." order by from_range",'')?>
							</select>
					 </td>
					</tr>
					<tr>
					  ...
					  <td width="247"  align="left" valign="top">
					  		<select name="employee_size[]" id="employee_size" multiple="multiple" style="width:300px;">
								<option value="">Any</option>
								<?=selectComboBox("select id,name from ".TABLE_EMPLOYEE_SIZE." order by from_range",'')?>
							</select>
								...
								<td width="209" height="27" align="left" valign="middle">Email Alerts will be delivered:</td>
								 <td width="273"  align="left" valign="middle">
									<select name="delivery_schedule" id="delivery_schedule" style="width:300px;">
										<option value="">Any</option>
										<?=selectComboBox("select name,name from ".TABLE_EMAIL_UPDATE." order by id",'')?>
									</select>
					...
					<tr>
					  ...
					  <td width="247"  align="left" valign="top">
						...
						<select name="industry[]" id="industry" multiple="multiple" style="width:300px;">
							...
							?>
							<optgroup label="<?=$indus_row['title']?>">
							<?=MultiSelectionComboBox("select industry_id,title from ".TABLE_INDUSTRY." where status=0 and parent_id='".$indus_row['industry_id']."'",$industry_id_arr)?>
							</optgroup>
							<?PHP } ?>
						</select>
					  </td>
        	...
        	<table width="673" border="0" align="center" cellpadding="0" cellspacing="0" >
				...
				<tr>
				  ...
				  <table width="490" border="0" align="center" cellpadding="2" cellspacing="0">
					  ...
					  <tr>
						...
						<td width="250" align="left" valign="middle"><?=$management_type?></td>
					  </tr>
				  </table></td>
				</tr>
				<tr>
				...
				<tr>
				  <td align="center" valign="middle"><table width="490" border="0" align="center" cellpadding="3" cellspacing="0">
					<tr>
					  <td width="232" height="27" align="left" valign="middle">Country:</td>
					  <td width="251" align="left" valign="top"><?=$country_name?></td>
					</tr>
					<tr>
					  <td width="232" height="27" align="left" valign="top">State:</td>
					  <td width="251"  align="left" valign="top"><?=$state_list?></td>
					</tr>
					<tr>
				...
				<tr>
				  <td align="center" valign="middle"><table width="490" border="0" align="center" cellpadding="3" cellspacing="0">
					...
					<tr>
					  <td width="232" height="27" align="left" valign="top">Industry:</td>
					  <td width="247"  align="left" valign="top"><?=$industry_list?></td>
					</tr>
					<tr>
					  <td width="232" height="27" align="left" valign="top">Size ($Revenue):</td>
					  <td width="247"  align="left" valign="top"><?=$revenue_size_list?></td>
					</tr>
					<tr>
					  <td width="232" height="27" align="left" valign="top">Size (Employees):</td>
					  <td width="247"  align="left" valign="top"><?=$employee_size_list?></td>
					</tr>
				  </table></td>
				</tr>
				<tr>
				  ...
				  <td align="center" valign="middle">
						<table width="214" border="0" align="center" cellpadding="0" cellspacing="0">
							<tr>
							  ...
							  <form name="frmAlertBack" id="frmAlertBack" method="post" action="user.php?action=CreateAlertBack&selected_menu=user&uID=<?=$uID?>">
