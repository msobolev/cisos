...
$cID = (isset($_GET['cID']) ? $_GET['cID'] : $select_data[0]);
    ...
    switch ($action) {
	  ...
	  case 'delete':
			...
			com_db_query("insert into ".TABLE_MOVEMENT_UPDATE_INFO."(page_name,query_string,add_date) values('admin-company-master','".com_db_input($del_mov_srt)."','".date("Y-m-d:H:i:s")."')");
	  ...
	  case 'alldelete':
			...
			for($i=0; $i< sizeof($company_id) ; $i++){
				...
				com_db_query("delete from " . TABLE_MOVEMENT_MASTER . " where company_id = '" . $company_id[$i] . "'");
				com_db_query("delete from " . TABLE_COMPANY_JOB_INFO . " where company_id = '" . $company_id[$i] . "'");
				$det_srt= "delete from " . TABLE_COMPANY_MASTER . " where company_id = '" . $company_id[$i] . "'";
				com_db_query("insert into ".TABLE_COMPANY_UPDATE_INFO."(page_name,query_string,add_date) values('admin-company-master','".com_db_input($det_srt)."','".date("Y-m-d:H:i:s")."')");
			}
		 	com_redirect("company-master.php?p=" . $p . "&selected_menu=master&msg=" . msg_encode("Company deleted successfully"));
	  ...
	  case 'edit':
			...
			$email_pattern = com_db_output($data_edit['email_pattern_id']); 
			$email_domain = com_db_output($data_edit['email_domain']); 
			$mail_server_settings = com_db_output($data_edit['mail_server_settings']); 
			...
			$mail_server_settings_db = com_db_output($data_edit['mail_server_settings']);
		...
		case 'editsave':
			...
			$email_domain = com_db_output($_POST['email_domain']);
			
			$mail_server_settings = com_db_output($_POST['mail_server_settings']);
			$company_email_pattern = com_db_output($_POST['company_email_pattern']);
			$email_domain = com_db_output($_POST['email_domain']);
			...
			leadership_page ='".$leadership_page."',email_pattern = '".$email_pattern."',email_pattern_id = '".$company_email_pattern."',email_domain = '".$email_domain."',mail_server_settings = '".$mail_server_settings."', address = '" . $address ."', address2 = '".$address2."', city = '".$city."', state = '".$state."', country = '".$country."', zip_code = '".$zip_code."', phone = '".$phone."',fax = '".$fax."',
	...
	case 'addsave':
			...
			$about_company = strip_tags($_POST['about_company']);
			$leadership_page = com_db_output($_POST['leadership_page']);
			$email_pattern = com_db_output($_POST['company_email_pattern']); 
			$email_domain = com_db_output($_POST['email_domain']);
			$mail_server_settings = com_db_output($_POST['mail_server_settings']);
			  ...
			  <td align="left">
              	 <div id="div_company" style="display:block;">
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top">
						<!-- <input type="text" name="email_pattern" id="email_pattern" size="30" value="<?=$email_pattern?>" />  -->
						
						
						<!-- NEW Code -->
						
						<select name="company_email_pattern" id="company_email_pattern" style="width:206px;"/>
						<?=selectComboBox("select pattern_id,email_pattern from ".TABLE_EMAIL_PATTERNS."",$email_pattern_id,'email_pattern')?>
						<option <?PHP if($email_pattern_id == '0') echo "selected"; ?> value="none">None</option>
						</select>
					...
					<tr>
                      <td width="25%" align="left" class="page-text" valign="top">&nbsp;&nbsp;&nbsp;Email Domain:</td>
                      <td width="75%" align="left" valign="top"><input type="text" name="email_domain" id="email_domain" size="30" value="<?=$email_domain?>" /></td>	
                    </tr>
					
					<?PHP
					
					//$mail_server_settings = mail_server_settings_ComboBox($mail_server_settings_db); 
					$mail_server_settings = mail_server_settings_ComboBox($mail_server_settings); 
					?>
					<tr>
                      <td width="25%" align="left" class="page-text" valign="top">&nbsp;&nbsp;&nbsp;Mail Server Settings:</td>
                      <td width="75%" align="left" valign="top">
					  <!-- <input type="text" name="mail_server_settings" id="mail_server_settings" size="30" value="" /> -->
					  <?=$mail_server_settings?></td>	
                    </tr>
            ...
            <tr>
			  <td align="left">
					...
					<tr>
                      ...
                      <td align="left" valign="top"><input type="text" name="email_domain" id="email_domain" size="30" value="" /></td>	
                    </tr>
					
					<?PHP
					
					$mail_server_settings = mail_server_settings_ComboBox(); 
					?>
					<tr>
                      <td width="25%" align="left" class="page-text" valign="top">&nbsp;&nbsp;&nbsp;Mail Server Settings:</td>
                      <td width="75%" align="left" valign="top">
            ...
            <tr>
			  <td align="left">
              	 <div id="div_company" style="display:block;">
					...
					<tr>
                      <td width="25%" align="left" class="page-text" valign="top">&nbsp;&nbsp;&nbsp;Email Domain:</td>
                      <td width="75%" align="left" valign="top"><?=$email_domain;?></td>	
                    </tr>
