...
$sql_query = "SELECT * FROM " . TABLE_PERSONAL_FILTER_ONOFF . " ORDER BY filter_id";
...
$fID = isset($_REQUEST["fID"]) ? $_REQUEST["fID"] : $data_sql['filter_id'];
  ...
  switch ($action) {
	...
	case 'edit':
	  $subscription_query = com_db_query("select * from " . TABLE_PERSONAL_FILTER_ONOFF . " where filter_id = '" . (int)$fID . "'");
	...
	case 'editsave':
		...
		com_db_query("update " . TABLE_PERSONAL_FILTER_ONOFF . " set filter_onoff ='".$filter_onoff."' where filter_id = '" . (int)$fID . "'");
      	
		com_redirect("personal_filter.php?selected_menu=personal&fID=". $fID . "&msg=" . msg_encode("Offer subscription is updated successfully"));
    ...
    default:
	   $subscription_query = com_db_query("select * from " . TABLE_PERSONAL_FILTER_ONOFF );
...
<script type="text/javascript" language="javascript">
	function confirm_del(sid){
		...
		if (agree)
			window.location = "personal_filter.php?selected_menu=personal&fID=" + sid + "&action=delete";
		else
			window.location = "personal_filter.php?selected_menu=personal&fID=" + sid ;
	}
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
			  ...
			  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="left" valign="middle" class="heading-text"><span class="pageHeading">Manage Personal Filter</span></td>
          ...
          <tr>
			...
			<form name="topicform" action="personal_filter.php" method="post">
			<table width="100%" align="left" cellpadding="0" cellspacing="0">
			  <tr>
			  	 <td width="51" align="left" valign="middle" class="right-border-text">#</td>
				 <td width="335" height="30" valign="middle" class="right-border"><span class="right-box-title-text">Validation Name</span></td>
                 <td width="268" height="30" valign="middle" class="right-border"><span class="right-box-title-text">ON/OFF</span></td>
			 ...
			 if(com_db_num_rows($exe_query)>0) {
				...
				<tr align="left">
					...
					<td width="335" align="left" valign="top" class="right-border-text"><a href="personal_filter.php?selected_menu=personal&action=details&fID=<?=$data['filter_id'];?>"><?=com_db_output($data['filter_name'])?></a></td>
					...
					<a href="#"><img src="images/small-edit-icon.gif" width="16" height="16" alt="Edit" title="Edit" border="0" onclick="window.location='personal_filter.php?selected_menu=personal&fID=<?=$data['filter_id']?>&action=edit'"></a><br />
					Edit</td>
				 </tr>
					<?php
					$i++;
          ...
          <tr>
            <td align="center" valign="top" class="right-bar-content-border-box">
				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                  	<td align="left"><span class="page-text">Validation Name:</span></td>
                  ...
                  <tr>
					...
					<td height="25" align="left"><input type="submit" value="Save" class="submitButton">&nbsp;<input type="button" value="Cancel" class="submitButton" onclick="window.location='personal_filter.php?selected_menu=personal&fID=<?=$fID;?>'" /></td>
				  </tr>
				  <tr><td colspan="2">&nbsp;</td></tr>
				  </form>
				</table>
          ...
          <tr>
            <td align="center" valign="top" class="right-bar-content-border-box">
				<table width="96%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr><td colspan="3"><input type="button" value="Back" class="submitButton" onclick="window.location='personal_filter.php?selected_menu=personal'" /></td></tr>
					<tr><td colspan="3">&nbsp;</td></tr>
				</table>
	</td>
				</tr>
