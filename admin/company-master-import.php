				...
				if(is_uploaded_file($data_file)){
					...
					if($get_ext=='csv'){
						...
						if(move_uploaded_file($data_file , $destination_file)){
							...
							//echo "<pre>";	print_r($filecontents);	echo "</pre>";
							//caption start
								...
								if(sizeof($newArray)== 21){
									...
									foreach($newArray as $key => $value){
										...
										if($p==0){
											...
											if($isCompanyWebsite>0){
												//echo "<br>FA Com Dup case: ".$isCompanyWebsite.":".$import_company_name;
												$dup_count++;
												$this_dup_count++;
											...
											*/	
											...
											//echo "<br><br><br>Revenue Value At start:".$import_revenue_type.":";
											...
											{
												//echo "<br>Revenue Value before: ".$import_revenue_type;;
												$import_revenue_type = str_replace(">$1B",">$1 Billion",$import_revenue_type);		
												//echo "<br>FAR Com In else if :::".$import_company_name."    Revenue Value after: ".$import_revenue_type;
											}
											...
											if($revenue_size_id==''){
												...
												//echo "<br>FAR Com in revenue IF: ".$import_company_name;
											...
											{
												//echo "<br>FAR Com in revenue ELSE: ".$import_company_name;
												$strQuery1 .= "'" . $revenue_size_id ."',";
											}	
											
											//echo "<br><br>REVENUE:".$import_revenue_type.":";
											...
											//echo "<br>SIZE:".$import_employee_size.":";
											...
											$industry_invalid = 0;
											//echo "<br>FA INDUSTRY Q: select industry_id from " . TABLE_INDUSTRY . " where title = '".str_replace(';',',',trim($tot_ind[0]))."'";
											...
											if(sizeof($tot_ind)==2){
												...
												//echo "<br>select industry_id from " . TABLE_INDUSTRY . " where title = '".str_replace(';',',',trim($tot_ind[0]))."'";
												//echo "<br>ind_group_id: ".$ind_group_id;
												$industry_id = com_db_GetValue("select industry_id from " . TABLE_INDUSTRY . " where title = '".str_replace(';',',',trim($tot_ind[1]))."'");
												
												//echo "<br>select industry_id from " . TABLE_INDUSTRY . " where title = '".str_replace(';',',',trim($tot_ind[1]))."'";
												...
												//echo "<br><br><br>In else Q:select industry_id from " . TABLE_INDUSTRY . " where title = '".str_replace(';',',',trim($tot_ind[0]))."' ";
											...
											//$import_zip_code = str_replace("'\\",'',$import_zip_code);
									...
									$strQuery2 .= ",'".date('Y-m-d')."')";
										...
										if($this_rejecteded_recs != ''){
											...
											//echo "<br>FA Com insertion case: ".$import_company_name.":".$import_company_website;
