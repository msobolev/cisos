...
$sql_query = "select * from " . TABLE_WEEKLY_UPDATE_DETAILS." order by add_date desc";

/***************** FOR PAGIN ***********************/
$starting_point = $items_per_page * ($p - 1);
/****************** END PAGIN ***********************/
$main_page = 'weekly-update-details.php';
...
if($action=='DemoEmailCode' || $action == 'DemoEmailShow'){
	...
	$emailCode = com_db_output(com_db_Getvalue("select sent_email from ".TABLE_DEMO_EMAIL_INFO." where info_id='".$info_id."'"));
}
if($action=='delete'){
	com_db_query("delete from " . TABLE_WEEKLY_UPDATE_DETAILS . " where info_id = '" . $mID . "'");
	com_redirect("weekly-update-details.php?p=" . $p . "&selected_menu=weeklyupdate&msg=" . msg_encode("Weekly update deleted successfully"));
}
...
<script type="text/javascript" language="javascript">
	...
	if (agree)
		window.location = "weekly-update-details.php?selected_menu=weeklyupdate&mID=" + nid + "&p=" + p + "&action=delete";
	else
		window.location = "weekly-update-details.php?selected_menu=weeklyupdate&mID=" + nid + "&p=" + p ;
	}
</script>
 <tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
          <tr>
            <td align="center" valign="middle" class="right"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="29%" align="left" valign="middle" class="heading-text">Weekly Update Details</td>
          ...
          <tr>
			...
			<form name="topicform" action="weekly-update-details.php?action=DemoEmailCreate&selected_menu=weeklyupdate" method="post">
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
			  <tr>
				...
				<td width="133" height="30" align="center" valign="middle" class="right-border"><span class="right-box-title-text">Full Weekly Update</span> </td>
			...
			?>          
			  <tr>
				...
				<td height="30" align="left" valign="middle" class="right-border-text"><a href="<?=HTTP_SITE_URL.'weekly/'.$data_sql['weekly_update_id'];?>" target="_blank">Details form website</a></td>
    ...
    <td align="center" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="666" align="right" valign="top"><table width="200" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
		<?=number_pages($main_page, $p, $total_data, 8, $items_per_page,"&selected_menu=weeklyupdate");?>		  
          </tr>
        </table></td>
...
<?php }elseif($action=='DemoEmailShow'){ ?>
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		 ...
		 <!--start iner table  -->
			...
			<tr>
				<td align="left" valign="top"><input type="button" class="submitButton" value="Back" onclick="window.location='weekly-update-details.php?selected_menu=weeklyupdate'" /></td>
			</tr>
