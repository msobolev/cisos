...
// Final correct file to append values in company DB when one column is not company_id 
// completed on 17 March 2015
						...
						if(move_uploaded_file($data_file , $destination_file)){
							...
							for($i=$columnheadings; $i<sizeof($filecontents); $i++) {
								...
								if(sizeof($newArray)== 2){
									...
									// com_redirect("company-master-append-nonPrimary.php?selected_menu=master&msg=" . msg_encode($msg));	
									}
							} 
    ...
    <td align="left" valign="top" bgcolor="#FFFFFF"><table width="975" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <form name="importfile" method="post" action="company-master-append-nonPrimary.php?selected_menu=master&action=save" enctype="multipart/form-data" onsubmit="return checkForm();">	
