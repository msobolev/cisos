                ...
                if($get_ext=='csv')
                {
                    ...
                    if(move_uploaded_file($data_file , $destination_file))
                    {
                        ...
                        else
                        {
                            ...
                            com_redirect("company-master-append-url.php?selected_menu=master&msg=" . msg_encode($msg));	
                        }
                        ...
                        for($i=$columnheadings; $i<sizeof($filecontents); $i++) 
                        {
                            ...
                            if(sizeof($newArray)== 2)
                            {
                                ...
                                $first_four = substr($import_company_val,0,4);
                                if($first_four != 'www.')
                                    $import_company_val = 'www.'.$import_company_val;
                                ...
                                $insSecondary = "INSERT into ".TABLE_COMPANY_WEBSITES."(company_id,company_website) VALUES('$import_company_id','".$import_company_val."')";
                                //echo "<br>insSecondary: ".$insSecondary;
                                com_db_query($insSecondary);
                            }
                            else
                            {
                                //die();
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td align="left" valign="top" class="right-bar-content-border-box">
                                ...
                                <form name="importfile" method="post" action="company-master-append-url.php?selected_menu=master&action=save" enctype="multipart/form-data" onsubmit="return checkForm();">	
