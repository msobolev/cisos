...
$sql_query = "select * from hre_profile_history order by h_id desc";
/***************** FOR PAGIN ***********************/
$starting_point = $items_per_page * ($p - 1);
/****************** END PAGIN ***********************/
$main_page = 'email-log.php';
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
            <tr>
                <td align="center" valign="middle" class="right"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="30%" align="left" valign="middle" class="heading-text">Email Log</td>
          ...
          <tr>
			...
			<form name="topicform" action="invoice-settings.php?action=alldelete&selected_menu=invoice" method="post">
                            <table width="100%" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="266" height="30" align="center" valign="middle" class="right-border-left"><div align="left" style="padding-left:10px;"><span class="right-box-title-text">To</span></div> </td>
                                    <td width="151" height="30" align="center" valign="middle" class="right-border"><div align="left" style="padding-left:10px;"><span class="right-box-title-text">From Name</span></div> </td>
                                    <td width="163" height="30" align="center" valign="middle" class="left-border"><div align="center"><span class="right-box-title-text">From Email</span></div></td>
                                </tr>
			 
                                <?PHP
                                $sql_query = "SELECT * FROM hre_profile_history";
                                ...
                                if($total_data>0) 
                                {
                                    ...
                                    {
                                       $to_email = $data_sql['to_email'];
                                       $from_name = $data_sql['from_name'];
                                       $from_email = $data_sql['from_email'];
                                ?>
                                       <tr>
                                           <td style="text-align:left;padding-left:10px;" height="30" align="left" valign="middle" class="right-border-left"><?=com_db_output($to_email);?></td>
                                           <td height="30" align="left" valign="middle" class="right-border-text"><?=com_db_output($from_name);?></td>
                                           <td height="30" align="left" valign="middle" class="right-border-text"><?=com_db_output($from_email);?>
