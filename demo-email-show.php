...
$alert_email_content = com_db_output(com_db_GetValue("select email_details from " . TABLE_DEMO_EMAIL_INFO . " where email_id='".$email_id."'"));
?>
...
if($alert_email_content ==''){
    ...
    $alert_email_content;
    $alert_email_content = str_replace('This newsletter was sent to you by CTOsOnTheMove.', 'This newsletter was sent to you by Cisosonthemove.', $alert_email_content);
