...
?>	 
  ...
  <tr>
    <td align="center" valign="top"  class="registration-page-bg">
    	<form name="frmCardInfo" id="frmCardInfo" method="post" action="<? if($free=='1Month'){echo 'submit-payment-month.php?action=DataRestore&email='.$email;}else{echo 'submit-payment-week.php?action=DataRestore&email='.$email;}?>">
