...
<!-- Header -->
<div>
	<div class="shell" style="background-color:#CCC;padding-top:8px;">
    	<div style="font-size:36px;color:#000;text-align:center;font-family:'Times New Roman', Times, serif;font-weight:bold;padding:2px 2px 15px 2px;">Thank You!</div>
        <div style="font-size:22px;color:#000;text-align:center;font-family:'Times New Roman', Times, serif;font-weight:normal;line-height:1.4em;padding-bottom:10px;">We deliver your request to your email inbox even as we speak… Meanwhile, check out our offer to put you in touch with 15,000+ of senior IT executives:</div>
    </div>
	...
	<div class="shell">
		...
		<div class="cl">&nbsp;</div>
		<div style="font-family: 'HelveticaNeueLTStd66MdIt'; font-size:28px; padding:15px 0 15px 4px;">Actionable Real-Time Sales Leads for Technology Companies</div>
	</div>
</div>
