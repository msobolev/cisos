...
<title><?='CISOsOnTheMove.com ::'.$PageTitle;?></title>
...
new HelloBar(53072,87093);
	...
	<div class="abo_top">
    	<div class="abo_topmid">
        	<div class="abo_topmid_left"><a href="<?=HTTP_SERVER?>index.php"><img src="css/images/new-logo.png" alt="" /></a></div>
    ...
    <div class="abo_foot">
    	<div class="abo_footmid">
        	<div class="abo_footleft abo_foottext">&copy; <?=date("Y");?> CISOsOnTheMove. All rights reserved.</div>
        </div>
    </div>
