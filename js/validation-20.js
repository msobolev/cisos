...
var ds=document.getElementById('delivery_schedule').value;var mb=document.getElementById('monthly_budget').value;if((ds=='Any'||ds=='')&&(mb=='Any'||mb=='')){alert("please select frequency or please select budget");return false;}
