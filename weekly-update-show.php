...
$weekly_update_id =$dim_url[sizeof($dim_url)-1];
$weekly_update_content = com_db_output(com_db_GetValue("select 	weely_update_details from " . TABLE_WEEKLY_UPDATE_DETAILS . " where weekly_update_id='".$weekly_update_id."'"));
?>
...
<head>
	...
	<title>Weekly Update Details</title>
...
if($weekly_update_content ==''){
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#eaeaea">
        ...
        <tr>
            <td align="center" valign="top" style="color:#00C;font-size:24px;">Weekly update not Available</td>
        </tr>
    </table>    
    <?
}else{
	echo $weekly_update_content;
}
?>
